...
function FranchiseSalesTable({ user, courseListTitles }) {
  const [filter, setFilter] = useState(false);
  const [filterData, setFilterData] = useState("");
  const [selectedView, setSelectedView] = useState("AddFsalesList");
...
export default FranchiseSalesTable;