...
import AddVip from "./AddForms/AddVip";
import ViewVip from "./Tables/ViewVip";
    ...
    <VipTableContainer>
      ...
      >
        ...
        >
          ...
          >
            <Tab label="View Vip" value="ViewVipList" />
            <Tab label="Add Vip" value="AddVipList" />
          </Tabs>
        </Box>

        <div>
          {selectedView === "ViewVipList" && (
            <ViewVip filterData={filterData} />
          )}
          {selectedView === "AddVipList" && <AddVip />}
        </div>
      </div>
    </VipTableContainer>
  );
