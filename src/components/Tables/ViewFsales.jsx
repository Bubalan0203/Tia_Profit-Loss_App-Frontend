  ...
  return (
    <TableContainer>
      ...
      <StyledTable>
        ...
        <tbody>
          {salesData.map((fsale, index) => (
            <TableRow key={fsale._id}>
              <TableCell>{index + 1}</TableCell>
              <TableCell>{fsale.productName}</TableCell>
              <TableCell>{fsale.description}</TableCell>
              <TableCell>{fsale.price}</TableCell>
              <TableCell>{fsale.count}</TableCell>
              <TableCell>{fsale.total}</TableCell>
