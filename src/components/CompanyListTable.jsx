...
import AddCompany from "./AddForms/AddCompany";
import ViewCompany from "./Tables/ViewCompany";
...
function VipListTable({ user, courseListTitles }) {
  ...
  const [selectedView, setSelectedView] = useState("ViewCompanyList");
    ...
    <VipTableContainer>
      ...
      >
        ...
        >
          ...
          >
            <Tab label="View Company Revenue" value="ViewCompanyList" />
            <Tab label="Add Company Revenue" value="AddCompanyList" />
          </Tabs>
        </Box>

        <div>
          {selectedView === "ViewCompanyList" && (
            <ViewCompany filterData={filterData} />
          )}
          {selectedView === "AddCompanyList" && <AddCompany/>}
        </div>
      </div>
    </VipTableContainer>
  );
